// Copyright 2014 The Aphrodite AUTHORS. All rights reserved.
//
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.

//    This program is modelled after the ssadump app and is designed to
//    generate ssa code from Google Go code. This is the first step in
//    generating code to another language
//    Copyright (Constant Innovations Inc) 2014
//    constantinnovationsinc@gmail.com
...
const usage = `aphrodite SSA builder and interpreter.
Usage: aphrodite [<flag> ...] <args> ...
Use -help flag to display options.

Examples:
% aphrodite -build=FPG hello.go            # quickly dump SSA form of a single package
% aphrodite -run -interp=T hello.go        # interpret a program, with tracing
...
func main() {
	if err := doMain(); err != nil {
		fmt.Fprintf(os.Stderr, "goAndroid: %s.\n", err)
		os.Exit(1)
	}
}
